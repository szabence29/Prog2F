 ...
 * hogy ez a program hiba nélkül leforduljon, és helyesen mûködjön!
 *
 * A program bemutatja a gtest_lite makróinak használatát.
 * A makrók mûködést nem kell megértenie, mivel számos még nem tanult megoldást
 * tartalmaznak.
 *
 */
...
int main() {
    ...
    TEST(Swap, int) {       // Teszt eset kezdete. A paraméterekbõl csak kiírás lesz
        int a = 1, b = 100;
        int a0 = a, b0 = b;
        swap(a, b);
